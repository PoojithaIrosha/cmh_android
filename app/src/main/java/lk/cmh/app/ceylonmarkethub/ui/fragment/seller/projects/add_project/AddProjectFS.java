...
public class AddProjectFS {
    ...
    public AddProjectFS(@Nullable String nameError, @Nullable String descriptionError, @Nullable String categoryError, @Nullable String skillsError, @Nullable String budgetError, @Nullable String durationError) {
    ...
    public AddProjectFS(boolean isValid) {
        this.nameError = null;
