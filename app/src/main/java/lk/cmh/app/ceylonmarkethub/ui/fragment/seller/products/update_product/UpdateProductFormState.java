...
public class UpdateProductFormState {
    ...
    public UpdateProductFormState(@Nullable String titleError, @Nullable String descriptionError, @Nullable String priceError, @Nullable String quantityError, @Nullable String conditionError) {
    ...
    public UpdateProductFormState(boolean isValid) {
